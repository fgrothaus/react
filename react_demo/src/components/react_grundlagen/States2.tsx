...
export function States2(){
    ...
    console.log("Lazy Initialisierung: " + state); // Macht nur Sinn, wenn man sich aus Performancegründen Berechnungen bei Rerendern sparen will. React prüft dann diesen State nicht auf eine Veränderung
